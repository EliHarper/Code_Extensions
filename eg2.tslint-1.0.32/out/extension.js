            ...
            if (fs.existsSync(tslintConfigFile)) {
                ...
                p.on('exit', (code, _signal) => __awaiter(this, void 0, void 0, function* () {
                    if (code === 0) {
                        ...
                        vscode_1.window.showErrorMessage('Could not run `tslint` to generate a configuration file. Please verify that you have tslint installed.');
                    }
                }));
            }
        });
            ...
            while (true) {
                if (result) {
                    ...
                    if (lastVersion !== document.version || lastVersion !== result.documentVersion) {
                        vscode_1.window.showInformationMessage("TSLint: Auto fix on save, fixes could not be applied.");
                        break;
                    }
